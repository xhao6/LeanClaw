  ...
  <view class="p-4 bg-gray-50 min-h-screen box-border">
    ...
    <view class="flex items-center justify-between mb-6 pt-2">
      <view class="flex items-center">
        <!-- Logo -->
        <image src="/static/images/logo-v1.png" class="w-10 h-10 rounded-xl mr-3 shadow-sm bg-white" mode="aspectFit" />
        <view>
...
const handleGoCase = () => {
  uni.reLaunch({ url: '/pages/discover/index?tab=case' })
}
const handleGoSkills = () => {
  uni.reLaunch({ url: '/pages/discover/index?tab=skill' })
}
