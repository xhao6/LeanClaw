...
Day 5 让你了解了 Skills 技能系统。这几个问题帮你思考如何"武装"你的助手：

1. **如果只能安装 3 个技能，你会选哪三个？** 考虑一下你的日常工作场景，什么技能组合能帮你解决最多问题？

2. **技能组合能产生"自动化工作流"——你能想到一个吗？** 比如"收到特定邮件 → 自动提取关键信息 → 转发给指定人"这样的流程。

3. **你想自己开发一个 Skill 吗？** 它可能帮你解决什么特定问题？
